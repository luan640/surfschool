import { DollarSign, ReceiptText, TicketPercent, Users, Activity, Clock3 } from 'lucide-react'
import { getReportFilterOptions, getReportsData } from '@/actions/reports'
...
export default async function ReportsPage({ searchParams }: Props) {
  ...
  const [filtersOptions, report] = await Promise.all([
